...
const card = 'bg-[#333333]/5 p-[16px] md:p-[20px] rounded-[8px]'
  ...
  return (
    <main className="min-h-screen" style={{ backgroundColor: advisingBg }}>
      ...
      <div className="min-w-[375px] max-w-[1440px] mx-auto px-[20px] md:px-[60px] pb-[60px]">
        ...
        {/* Ways I've helped – case study articles */}
        <section className="pb-[50px] md:pb-[60px]">
          <h2 className={`${sectionTitle} mb-[30px]`} style={{ color: advisingText }}>Ways I've helped</h2>
          <div className="flex flex-col gap-[12px]">
            {caseStudies.map((study) => (
              ...
              >
                ...
                <p className="font-['Haas_Grot_Disp',_sans-serif] text-[12px] tracking-[0.05em] uppercase" style={{ color: advisingText, opacity: 0.7 }}>
                  {study.readTime}
                </p>
              </Link>
            ))}
        ...
        <section className="pb-[50px] md:pb-[60px]">
          <h2 className={`${sectionTitle} mb-[30px]`} style={{ color: advisingText }}>Other ways I can help</h2>
        ...
        <section className="pb-[50px] md:pb-[60px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[24px]">
            {howItWorks.cards.map((c, i) => (
              <div
                key={i}
                className="rounded-[10px] overflow-hidden bg-[#333333]/5 border border-[#333333]/10 flex flex-col"
              >
                <div className={`px-[20px] py-[14px] ${i === 0 ? 'bg-[#333333]/10' : 'bg-[#333333]/15'}`}>
                ...
                <div className="px-[20px] pt-[24px] pb-[20px] flex flex-col flex-1">
                  ...
                  <ul className="space-y-[10px] mb-[16px]">
                    {c.whatDoIGet.map((item, j) => (
                      <li key={j} className="flex items-start gap-[10px]">
                        <span className="mt-[6px] w-[6px] h-[6px] rounded-full border border-[#333333] flex-shrink-0" aria-hidden />
                  ...
                  <div className="border-t border-[#333333]/20 pt-[16px] mt-auto">
