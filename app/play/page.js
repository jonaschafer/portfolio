...
const projects = [
  {
    ...
    name: 'Git, drawn out',
    description:
      'An interactive commit graph for the git commands I kept re-learning: branch, merge, rebase, stash, worktree, cherry-pick, reset and revert. Every frame is generated by a small model of git.',
    date: '2026.09.09',
    type: 'REACT',
    tags: ['React', 'Next.js'],
    path: '/play/git',
